...
public:
    ...
    void insert_data(const Entity entity, T component)
    {
        CGX_ASSERT(
            m_entity_to_index_map.find(entity) == m_entity_to_index_map.end(),
    ...
    // Returns the component data associated with 'entity'.
