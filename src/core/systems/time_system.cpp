...
void TimeSystem::add_accumulator(const double dt)
{
    m_accumulator += dt;
}

void TimeSystem::sub_accumulator(const double dt)
{
    m_accumulator -= dt;
}

double TimeSystem::get_accumulator() const
{
    return m_accumulator;
}

double TimeSystem::get_fixed_timestep() const
{
    return m_fixed_timestep;
}
