...
{
    return m_render_buffer_id;
}

void Framebuffer::getSize(uint32_t& width, uint32_t& height) const
{
    width  = m_width;
    height = m_height;
}
...
void Framebuffer::getClearColor(float& r, float& g, float& b, float& a) const
{
    r = m_CCR;
    g = m_CCG;
    b = m_CCB;
